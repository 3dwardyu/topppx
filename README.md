This is a simple app that utilizes the 500px API to allow users to see the current popular photos on the site and allow users to like these photos if they are logged in.
